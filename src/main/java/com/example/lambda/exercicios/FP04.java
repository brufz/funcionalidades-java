...
public class FP04 {
    ...
    public static void main(String[] args) {
        ...
        boolean b1 = courses
                .stream()
                .anyMatch(course -> course.getReviewScore() > 90);
        System.out.println("Any course match with score greater then 90? " + b1);

        boolean b2 = courses
                .stream()
                .noneMatch(c -> c.getNoOfStudents() == 20005);
        ...
        List<Course> collect = courses
                .stream()
                .sorted(comparingByNoOfStudents)
                .collect(Collectors.toList());
        List<Course> collectDecreasing = courses
                .stream()
        ...
        List<Course> collectTwoItens = courses
                .stream()
                .sorted(comparingTwoItens)
                .collect(Collectors.toList());
        System.out.println(collectTwoItens);

        Comparator<Course> comparingNames = Comparator.comparing(Course::getName);
        List<Course> collect1 = courses
                .stream()
                .sorted(comparingNames)
                .collect(Collectors.toList());
        System.out.println(collect1);

        //limit
        List<Course> collect2 = courses
                .stream()
                .sorted(comparingTwoItens)
                .limit(3)
                .collect(Collectors.toList());
        ...
        System.out.println(courses
                .stream()
                .dropWhile(condition -> condition.getReviewScore() < 95)
                .collect(Collectors.toList()));
        ...
        System.out.println(courses
                .stream()
                .takeWhile(condition -> condition.getReviewScore() < 98)
                .collect(Collectors.toList()));
